...
dataAnalysis = cbind(missingSexOrien, data1SexOrien, female, otherGI, black, hispanic, multi, otherEth, age = data1$age, site = data1$site)
...
library(Zelig)
z.out1 <- zelig(missingSexOrien ~ female +data1SexOrien + otherGI + black + hispanic + multi + otherEth + site, model = "logit", data = dataAnalysis, cite = FALSE)
summary(z.out1)
